...
namespace Sandogh.Persistance.Migrations
{
    ...
    [Migration("20220115160118_AddProduct")]
            ...
            modelBuilder.Entity("Sandogh.Domain.Products.Product", b =>
                {
                    ...
                    b.HasOne("Sandogh.Domain.Products.ProductCategory", "productCategory")
                        .WithMany("Products")
                        .HasForeignKey("ProductCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Sandogh.Domain.Products.ProductSize", "ProductSize")
                        .WithMany("Products")
